...
func (e UserEdges) PagesOrErr() ([]*Page, error) {
	if e.loadedTypes[0] {
		return e.Pages, nil
	}
...
// QueryPages queries the "pages" edge of the User entity.
func (u *User) QueryPages() *PageQuery {
	return NewUserClient(u.config).QueryPages(u)
}

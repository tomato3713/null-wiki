...
func (uc *UserCreate) AddPageIDs(ids ...int) *UserCreate {
	uc.mutation.AddPageIDs(ids...)
	return uc
}

// AddPages adds the "pages" edges to the Page entity.
func (uc *UserCreate) AddPages(p ...*Page) *UserCreate {
	ids := make([]int, len(p))
	for i := range p {
		ids[i] = p[i].ID
	}
	return uc.AddPageIDs(ids...)
}
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if nodes := uc.mutation.PagesIDs(); len(nodes) > 0 {

...
func (pq *PageQuery) QueryOwner() *UserQuery {
...
func (pq *PageQuery) WithOwner(opts ...func(*UserQuery)) *PageQuery {
	query := (&UserClient{config: pq.config}).Query()
...
func (pq *PageQuery) loadOwner(ctx context.Context, query *UserQuery, nodes []*Page, init func(*Page), assign func(*Page, *User)) error {
